...
My current research centers on **Generative Models**, with a focus on generation and editing tasks across image and 3D domains. I am actively pursuing (1) Ph.D. positions for Fall 2027, and (2) research collaborations on related topics. Feel free to reach out to me at <i class="fas fa-envelope"></i> [xndsb330@email.swu.edu.cn](mailto:xndsb330@email.swu.edu.cn) or <i class="fas fa-envelope"></i> [xinyupu@seu.edu.cn](mailto:xinyupu@seu.edu.cn) if you're interested in discussing research opportunities or collaborations.
